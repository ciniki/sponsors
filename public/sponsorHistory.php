...
function ciniki_sponsors_sponsorHistory($ciniki) {
    ...
    $rc = ciniki_sponsors_checkAccess($ciniki, $args['business_id'], 'ciniki.sponsors.sponsorHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.sponsors', 'ciniki_sponsor_history', $args['business_id'], 'ciniki_sponsors', $args['sponsor_id'], $args['field']);
}
?>
