...
function ciniki_sponsors_refDetailHistory($ciniki) {
    ...
    $rc = ciniki_sponsors_checkAccess($ciniki, $args['tnid'], 'ciniki.sponsors.refDetailHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.sponsors', 'ciniki_sponsor_history', $args['tnid'], 'ciniki_sponsor_objrefdetails', $args['detail_id'], $args['field']);
}
?>
